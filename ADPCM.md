...
On-disc format version 23 uses 22.05 kHz mono IMA ADPCM as its only audio format. The Sub CPU
...
- Header offset 54 is the decoded RF5C164 sample count per frame. Format version 23
...
On-disc format version 23の音声形式は、22.05 kHz mono IMA ADPCMのみです。Sub CPUが時刻指定された
...
- Header offset 54は、frameごとのdecode済みRF5C164 sample数です。Format version 23の
